...
public class OrderStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            loadStoresOwnOrders(Common.currentUser.getStoreName());
        }
        else
        {
    ...
    private void loadStoresOwnOrders(String storeName) {
        adapter = new FirebaseRecyclerAdapter<Request, OrderViewHolder>(
            ...
            protected void populateViewHolder(OrderViewHolder viewHolder, final Request model, final int position) {
                ...
                viewHolder.txtOrderStoreName.setText(model.getStoreName());
    ...
    private void showUpdateDialog(String key, final Request item) {
        ...
        spinner.setItems("Placed","On Route To Store","Shipped From Warehouse");
